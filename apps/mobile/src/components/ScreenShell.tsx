...
export const ScreenShell = ({
  ...
  <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col px-4 pb-8 pt-4 text-foreground sm:px-6">
    <header className="mb-6 overflow-hidden rounded-[36px] border border-white/70 bg-white/90 shadow-card backdrop-blur">
      <div className="bg-[linear-gradient(135deg,rgba(220,238,245,0.95),rgba(234,244,233,0.95))] px-6 py-5 sm:px-7">
    ...
    <nav className="sticky bottom-3 mt-8 rounded-[30px] border border-white/70 bg-white/95 p-2 shadow-card backdrop-blur">
